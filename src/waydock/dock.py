...
class DockApplication:
    ...
    def startGTK(self):
        ...
        LayerShell.set_anchor(self.window, ANCHOR[waydockConfig.window.anchor], True)  # pyright: ignore # noqa
        # margins
        ...
        LayerShell.set_margin(
            self.window, LayerShell.Edge.TOP, waydockConfig.window.margin_top
        )  # pyright: ignore # noqa
